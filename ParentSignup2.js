...
const ParentSignupScreen2 = ({navigation}) => ( 
    <View style={styles.container}>
        <ImageBackground source={bgImage} style={styles.image}>
        <View style = {styles.buttonStyle}>
        <Text title='Sign Up' style = {styles.returnbutton} onPress={() => navigation.navigate('ParentSignup', {name: 'ParentSignup'})}>Back</Text>
            </View>
        <View style = {styles.form}>
            <View style = {styles.formquestions}>
              <TextInput style = {styles.question}placeholder="Child First Name" />
              <TextInput style = {styles.question}placeholder="Child Last Name" />
              <TextInput style = {styles.question}placeholder="Parent ID" />
              <TextInput style = {styles.question}placeholder="Phone Number" />
...
export default ParentSignupScreen2;